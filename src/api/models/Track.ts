...
export function TrackFromJSONTyped(json: any, ignoreDiscriminator: boolean): Track {
    ...
    return {
        ...
        'trackCensoredName': json['trackCensoredName'] == null ? undefined : json['trackCensoredName'],
        'trackViewUrl': json['trackViewUrl'] == null ? undefined : json['trackViewUrl'],
        'previewUrl': json['previewUrl'] == null ? undefined : json['previewUrl'],
        'artworkUrl30': json['artworkUrl30'] == null ? undefined : json['artworkUrl30'],
        'artworkUrl60': json['artworkUrl60'] == null ? undefined : json['artworkUrl60'],
        'artworkUrl100': json['artworkUrl100'] == null ? undefined : json['artworkUrl100'],
        'collectionPrice': json['collectionPrice'] == null ? undefined : json['collectionPrice'],
        'trackPrice': json['trackPrice'] == null ? undefined : json['trackPrice'],
        'trackRentalPrice': json['trackRentalPrice'] == null ? undefined : json['trackRentalPrice'],
        'collectionHdPrice': json['collectionHdPrice'] == null ? undefined : json['collectionHdPrice'],
        'trackHdPrice': json['trackHdPrice'] == null ? undefined : json['trackHdPrice'],
        'trackHdRentalPrice': json['trackHdRentalPrice'] == null ? undefined : json['trackHdRentalPrice'],
        'releaseDate': json['releaseDate'] == null ? undefined : json['releaseDate'],
        'collectionExplicitness': json['collectionExplicitness'] == null ? undefined : json['collectionExplicitness'],
        'trackExplicitness': json['trackExplicitness'] == null ? undefined : json['trackExplicitness'],
        'trackTimeMillis': json['trackTimeMillis'] == null ? undefined : json['trackTimeMillis'],
        'country': json['country'] == null ? undefined : json['country'],
        'currency': json['currency'] == null ? undefined : json['currency'],
        'primaryGenreName': json['primaryGenreName'] == null ? undefined : json['primaryGenreName'],
